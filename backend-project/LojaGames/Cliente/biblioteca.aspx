<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="biblioteca.aspx.cs" Inherits="LojaGames.Cliente.biblioteca" %>
    ...
    <div>
        ...
        <div>
            <form id="form1" runat="server">
                <asp:Panel ID="panelBiblioteca" runat="server">
                    ...
                    <asp:UpdatePanel ID="updateBiblioteca" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gridBiblioteca" runat="server" AutoGenerateColumns="false" GridLines="None" AllowSorting="true" Width="100%" Font-Size="14px">
                                <Columns>
                                    <%--ID JOGO--%>
