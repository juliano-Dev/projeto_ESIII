<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro_cliente.aspx.cs" Inherits="LojaGames.cadastro_cliente" %>
    ...
    <form id="form1" runat="server">
        <div>
            <fieldset>
                ...
                <%--Botão cadastrar--%>
                <asp:Button Text="Cadastrar" OnClick="Btn_Cadastrar_Cliente" runat="server" /><br />
            </fieldset>
            <asp:LinkButton href="Default.aspx" runat="server">&larr; Voltar</asp:LinkButton>
        </div>
    </form>
</body>
</html>
